    ...
    <div className='signup'>
      <form onSubmit={handleSubmit}>
        <div className='info'>
          ...
          <input type='number' name='studentId' value={formData.studentId} onChange={handleChange} required /><br />

          <label>Student Password:</label>
          <input type='password' name='studentPassword' value={formData.studentPassword} onChange={handleChange} required /><br />
